...
let digitalPins = new Array(14).fill(0);
//pwm on  3,5,6,9,10,11 analogwrite
const PWMindices = [3, 5, 6, 9, 10, 11];
//analog read pins
let AnalogPins = new Array(6).fill(0);
function executeProgram(hex) {
    runner = new AVRRunner(hex);
    const MHZ = 16000000;
    let lastState = new Array(14).fill(PinState.Input);
    let lastStateCycles = new Array(14).fill(0);
    let lastUpdateCycles = new Array(14).fill(0);
    let ledHighCycles = new Array(14).fill(0);
    ...
    runner.execute((cpu) => {
        ...
        //digital read values
        const digRead = new Array(14).fill(0);
        //digital write
...
function compileAndRun() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = yield buildHex(BLINK_CODE);
            if (result.hex) {
